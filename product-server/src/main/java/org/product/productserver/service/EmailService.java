...
import static org.product.productserver.constant.EmailConstant.*;
import static org.product.productserver.constant.EmailType.*;
...
public class EmailService {
    ...
    private Message createEmail(User user,String siteUrl,ConfirmationToken confirmationToken, int emailIdentifier, String randomPassword) throws MessagingException,
        ...
        mainPart.setText("<section>\n" +
                ...
                " <p>Welcome to Product! Thanks so much for joining our platform. We're looking forward to helping you with our products.</p>\n" +
                ...
                " <p>Sincerely,<br>Eleni Aoursalidou, customer service agent</p>\n" +
                " </section>", "US-ASCII", "html");
        }
        content.addBodyPart(mainPart);
        // Image part
        MimeBodyPart imagePart = new MimeBodyPart();
        imagePart.attachFile("src/product.jpg");
